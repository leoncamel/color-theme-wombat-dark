;;; color-theme-wombat-dark.el --- a dark version of wombat color-theme

;; Author: Scott Jaderholm <jaderholm@gmail.com>
;; Maintainer : Leon Zhang <leoncamel@gmail.com>
...
(defun color-theme-wombat-dark ()
  ...
  (color-theme-install
   '(color-theme-wombat+
     ...
     (default ((t (:stipple nil :background "black" :foreground "#f6f3e8" :inverse-video nil :box nil :strike-through nil :overline nil :underline nil :slant normal :weight normal :width normal))))
...
(add-to-list 'color-themes '(color-theme-wombat-dark  "Wombat Dark" "Leon Zhang <leoncamel@gmail.com> based on color-theme-wombat+"))

(provide 'color-theme-wombat-dark)
;;; color-theme-wombat-dark.el ends here
